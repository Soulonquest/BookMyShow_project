...
event_hub_connection_str = 'Endpoint=sb://bookmyshow-project.servicebus.windows.net/;SharedAccessKeyName=paymentsPolicy;SharedAccessKey=JkRJuHCqdvmGPqMrCXNe7B9fNsQPPWNCB+AEhGmEVK4=;EntityPath=paymentstopic'
