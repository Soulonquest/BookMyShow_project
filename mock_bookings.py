...
event_hub_connection_str = 'Endpoint=sb://bookmyshow-project.servicebus.windows.net/;SharedAccessKeyName=bookingsPolicy;SharedAccessKey=I3TZSDrDfXrt/Y2vhUld+xQKh0Ba++dVs+AEhFYODeo=;EntityPath=bookingstopic'
